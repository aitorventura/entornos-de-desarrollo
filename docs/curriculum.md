...
### RA2 — Entornos Integrados de Desarrollo
...
### RA4 — Optimización y Documentación
...
### RA6 — Diagramas de Comportamiento
...
### Tema 1 — Desarrollo de software (→ RA1)
...
### Tema 2 — Instalación y uso de entornos de desarrollo (→ RA2)
...
### Tema 3 — Diseño y realización de pruebas (→ RA3)
...
### Tema 4 — Optimización y documentación (→ RA4)
...
- Control de versiones. Estructura de las herramientas de control de versiones. Repositorio. Herramientas de control de versiones. Uso integrado en el entorno de desarrollo.
- Repositorios remotos.
- Documentación. Uso de comentarios. Alternativas.
- Integración continua. Herramientas.

### Tema 5 — Elaboración de diagramas de clases (→ RA5)
...
### Tema 6 — Elaboración de diagramas de comportamiento (→ RA6)
